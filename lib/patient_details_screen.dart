              ...
              Expanded(
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    var results = [];
                    if (snapshot.hasData) {
                      // Show ONLY DO30 results per user request
                      results = snapshot.data!.docs.where((doc) {
                        final data = doc.data() as Map<String, dynamic>;
                        return data['testName'] == 'DO30';
                      }).toList();
                      ...
                      results.sort((a, b) {
                        ...
                        final Timestamp? tA = dataA['timestamp'] as Timestamp?;
                        final Timestamp? tB = dataB['timestamp'] as Timestamp?;
                                ...
                                DataCell(
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        isRtl ? "كلمة صحيحة" : "mots corrects",
